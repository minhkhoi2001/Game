...
import MBBoncangdacbiet from "./pages/game/XSMB/4cangdacbiet";
//XSMT
...
import MNBoncangdacbiet from "./pages/game/XSMN/4cangdacbiet";
            ...
            {!isAllowedDo ? (
                <Router>
                    <Routes>
                        ...
                        <Route element={<CSKH />} path="/service" />
                        ...
                        <Route path="/" element={<PrivateRoute />}>
                            ...
                            <Route element={<XD3 />} path="xocdia3" />
                            <Route element={<XD5 />} path="xocdia5" />
                            {/* Xổ số 3p */}
                            ...
                            <Route element={<MBBoncangdacbiet />} path="/xsmb/4cangdacbiet" />
                            {/* Xổ số miền nam */}
                            ...
                            <Route element={<MNBoncangdacbiet />} path="/xsmn/4cangdacbiet/:id" />
                            {/* Xổ số miền trung */}
                            ...
                            <Route element={<HistoryAdd />} path="/recharge_record" />
