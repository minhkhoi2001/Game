...
function Set5() {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/bet5/getadmin`).then((res) => {
            setBet(res.data.data[0]);
            setDulieunhap(new Date(res.data.data[0].createdAt));
            setStart(true);
        });
        axios
            .get(`${process.env.REACT_APP_API_URL}/bet5/getallbet`, {})
            .then((res) => {
                setTotal(res.data.data);
            })
            .catch(() => setTotal(null));
        axios
            .get(`${process.env.REACT_APP_API_URL}/bet5/list30bet`, {})
            .then((res) => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/bet5/getcurrent`, {}).then((res) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (e.target.bet.value) {
            axios
                .post("https://server.best96tx.com/bet5/update", formData)
                .then((res) => {
                        ...
                        <Box
                            ...
                            <Container maxWidth={false}>
                                            ...
                                            ? current.map((item) => (
                                                  <>
                                                      <TableRow>
                                                          ...
                                                          <TableCell sx={{ padding: "10px" }}>{GetNameChoose(Number(item.state))}</TableCell>
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <h2>Sửa kết quả</h2>
                                    <input min="10000" max="99999" type="number" name="bet" id="bet" />
