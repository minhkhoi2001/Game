...
function Set5() {
	...
	useEffect(() => {
		...
		axios.get(`http://localhost/bet5/getadmin`).then((res) => {
		...
		axios
			...
			.catch(() => setTotal(null));
		axios
			.get(`http://localhost/bet5/list30bet`, {})
			.then((res) => {
		...
		axios.get(`http://localhost/bet5/getcurrent`, {}).then((res) => {
	...
	const handleSubmit = (e) => {
		...
		if (e.target.bet.value) {
			axios
				.post("http://localhost/bet5/update", formData)
				.then((res) => {
