...
function SetXS3p() {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/xucsac3/getadmin`).then((res) => {
        ...
        axios
            ...
            .catch(() => setTotal(null));
        axios
            .get(`${process.env.REACT_APP_API_URL}/xucsac3/list30bet`, {})
            .then((res) => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/xucsac3/getcurrent`).then((res) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (e.target.bet.value) {
            axios
                .post("https://server.best96tx.com/xucsac3/update", formData)
                .then((res) => {
