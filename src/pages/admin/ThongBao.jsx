...
function ThongBao() {
	...
	useEffect(() => {
		if (load == false) {
			axios
				.get(`https://server.best96tx.com/notification/getSale`)
				.then((res) => {
	...
	const handleSubmit = (e) => {
		...
		axios
			.post(`https://server.best96tx.com/notification/create`, formData)
			.then((res) => {
				setShow(false);
									...
									<div className="edit_account_bankl">
										{data != null ? (
											<form onSubmit={(e)=>{
												...
												axios
													.post(`https://server.best96tx.com/notification/updatebyadmin`, formData)
													.then((res) => {
														setShow(false);
