...
function Set1() {
	...
	useEffect(() => {
		...
		axios.get(`https://d3s.vnvip294.com/bet1/getadmin`).then((res) => {
		...
		axios
			...
			.catch(() => setTotal(null));
		axios
			.get(`https://d3s.vnvip294.com/bet1/list30bet`, {})
			.then((res) => {
		...
		axios.get(`https://d3s.vnvip294.com/bet1/getcurrent`).then((res) => {
	...
	const handleSubmit = (e) => {
		...
		if (e.target.bet.value) {
			axios
				.post("https://d3s.vnvip294.com/bet1/update", formData)
				.then((res) => {
																...
																<form
																	onSubmit={(e) => {
																		...
																		if (e.target.result.value) {
																			axios
																				.post(
																					"https://d3s.vnvip294.com/bet1/update",
																					formData
																				)
																				.then((res) => {
