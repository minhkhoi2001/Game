...
function Set1() {
	...
	useEffect(() => {
		...
		axios.get(`https://server.luckkylotte9d.com/bet1/getadmin`).then((res) => {
		...
		axios.get(`https://server.luckkylotte9d.com/bet1/getcurrent`).then((res) => {
	...
	const handleSubmit = (e) => {
		...
		axios
			.post("https://server.luckkylotte9d.com/bet1/update", formData)
			.then((res) => {
