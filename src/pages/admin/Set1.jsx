...
function Set1() {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/bet1/getadmin`).then((res) => {
        ...
        axios
            ...
            .catch(() => setTotal(null));
        axios
            .get(`${process.env.REACT_APP_API_URL}/bet1/list30bet`, {})
            .then((res) => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/bet1/getcurrent`).then((res) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (e.target.bet.value) {
            axios
                .post("https://server.best96tx.com/bet1/update", formData)
                .then((res) => {
