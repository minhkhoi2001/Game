...
function SetXD3p() {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/xd3/getadmin`).then((res) => {
        ...
        axios
            ...
            .catch(() => setTotal(null));
        axios
            .get(`${process.env.REACT_APP_API_URL}/xd3/list30bet`, {})
            .then((res) => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/xd3/getcurrent`).then((res) => {
