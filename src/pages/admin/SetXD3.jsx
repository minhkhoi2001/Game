...
function SetXD3p() {
	...
	useEffect(() => {
		...
		axios.get(`http://localhost/xd3/getadmin`).then((res) => {
		...
		axios
			...
			.catch(() => setTotal(null));
		axios
			.get(`http://localhost/xd3/list30bet`, {})
			.then((res) => {
		...
		axios.get(`http://localhost/xd3/getcurrent`).then((res) => {
	...
	const handleSubmit = (e) => {
		...
		if (e.target.bet.value) {
			axios
				.post("http://localhost/xd3/update", formData)
				.then((res) => {
