...
function SetXD5p() {
	...
	useEffect(() => {
		...
		axios.get(`https://server.best96tx.com/xd5/getadmin`).then((res) => {
		...
		axios
			...
			.catch(() => setTotal(null));
		axios
			.get(`https://server.best96tx.com/xd5/list30bet`, {})
			.then((res) => {
		...
		axios.get(`https://server.best96tx.com/xd5/getcurrent`).then((res) => {
																...
																<form
																	onSubmit={(e) => {
																		...
																		if (e.target.result.value) {
																			axios
																				.post(
																					"https://server.best96tx.com/xd5/update",
																					formData
																				)
																				.then((res) => {
