...
function SetXD5p() {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/xd5/getadmin`).then((res) => {
        ...
        axios
            ...
            .catch(() => setTotal(null));
        axios
            .get(`${process.env.REACT_APP_API_URL}/xd5/list30bet`, {})
            .then((res) => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/xd5/getcurrent`).then((res) => {
    ...
    useEffect(() => {
        ...
        if (start) {
            ...
            myTimeout = setTimeout(() => {
                setSecond(second - 1);
                axios
                    .get(`${process.env.REACT_APP_API_URL}/xd3/getcurrent`)
                    .then((res) => {
                        setCurrent(res.data.data);
                    })
    ...
    const handleSubmit = (e) => {
        ...
        if (e.target.bet.value) {
            axios
                .post("https://server.best96tx.com/xd5/update", formData)
                .then((res) => {
                                            ...
                                            ? current.map((item) => (
                                                  <>
                                                      <TableRow>
                                                          ...
                                                          <TableCell sx={{ padding: "10px" }}>{Number(item.money).toLocaleString()}</TableCell>
