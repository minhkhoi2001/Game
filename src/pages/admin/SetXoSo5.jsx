...
function SetXoSo5() {
	...
	useEffect(() => {
		...
		axios.get(`https://server.luckkylotte9d.com/Xoso5/getadmin`).then((res) => {
			setBet(res.data.data[0]);
			setDulieunhap(new Date(res.data.data[0].createdAt));
			setStart(true);
		});
		axios
			.get(`https://server.luckkylotte9d.com/Xoso5/getallbet`, {})
			.then((res) => {
		...
		axios.get(`https://server.luckkylotte9d.com/Xoso5/getcurrent`, {}).then((res) => {
	...
	const handleSubmit = (e) => {
		...
		axios
			.post("https://server.luckkylotte9d.com/Xoso5/update", formData)
			.then((res) => {
