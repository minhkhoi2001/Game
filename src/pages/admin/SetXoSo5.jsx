...
function SetXoSo5() {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/Xoso5/getadmin`).then((res) => {
        ...
        axios
            ...
            .catch(() => setTotal(null));
        axios
            .get(`${process.env.REACT_APP_API_URL}/Xoso5/list30bet`, {})
            .then((res) => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/Xoso5/getcurrent`, {}).then((res) => {
