...
function SetXoSo() {
	...
	useEffect(() => {
		...
		axios.get(`https://server.luckkylotte9d.com/Xoso3/getadmin`).then((res) => {
			setBet(res.data.data[0]);
			setDulieunhap(new Date(res.data.data[0].createdAt));
			setStart(true);
		});
		axios
			.get(`https://server.luckkylotte9d.com/Xoso3/getallbet`, {})
			.then((res) => {
		...
		axios.get(`https://server.luckkylotte9d.com/Xoso3/getcurrent`, {}).then((res) => {
	...
	const handleSubmit = (e) => {
		...
		axios
			.post("https://server.luckkylotte9d.com/Xoso3/update", formData)
			.then((res) => {
