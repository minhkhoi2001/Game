...
function SetXoSo() {
	...
	useEffect(() => {
		...
		axios.get(`https://server.best96tx.com/Xoso3/getadmin`).then((res) => {
		...
		axios
			...
			.catch(() => setTotal(null));
		axios
			.get(`https://server.best96tx.com/Xoso3/list30bet`, {})
			.then((res) => {
		...
		axios.get(`https://server.best96tx.com/Xoso3/getcurrent`, {}).then((res) => {
