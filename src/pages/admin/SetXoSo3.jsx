...
function SetXoSo() {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/Xoso3/getadmin`).then((res) => {
            setBet(res.data.data[0]);
            setDulieunhap(new Date(res.data.data[0].createdAt));
            setStart(true);
        });
        axios
            .get(`${process.env.REACT_APP_API_URL}/Xoso3/getallbet`, {})
            .then((res) => {
                setTotal(res.data.data);
            })
            .catch(() => setTotal(null));
        axios
            .get(`${process.env.REACT_APP_API_URL}/Xoso3/list30bet`, {})
            .then((res) => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/Xoso3/getcurrent`, {}).then((res) => {
    ...
    const handleSubmit = (e) => {
        ...
        axios
            .post("https://server.best96tx.com/Xoso3/update", formData)
            .then((res) => {
                ...
                <DashboardLayout>
                    {
                        <Box
                            ...
                            <Container maxWidth={false}>
                                <div className="container_set">Set kèo 3p</div>
                                            ...
                                            ? current.map((item) => (
                                                  <>
                                                      <TableRow>
                                                          ...
                                                          <TableCell sx={{ padding: "10px" }}>{GetNameChoose(item.state, item.type)}</TableCell>
                                ...
                                <form onSubmit={handleSubmit}>
                                                        ...
                                                        <td>
                                                            <span id="mb_prize_0" className="special-prize div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="dacbiet"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[0] == null ? bet.dacbiet : numbers[0]}
                                                        ...
                                                        <td>
                                                            <span id="mb_prize_1" className="prize1 div-horizontal">
                                                                <input
                                                                    ...
                                                                    max="99999"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[1] == null ? bet.nhat : numbers[1]}
                                                        ...
                                                        <td>
                                                            <span id="mb_prize_2" className="prize2 div-horizontal">
                                                                <input
                                                                    ...
                                                                    max="99999"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[2] == null ? bet.hai.split(" ")[0] : numbers[2]}
                                                            ...
                                                            <span id="mb_prize_3" className="prize2 div-horizontal">
                                                                <input
                                                                    ...
                                                                    max="99999"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[3] == null ? bet.hai.split(" ")[1] : numbers[3]}
                                                        ...
                                                        <td>
                                                            <span id="mb_prize_4" className="prize3 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="ba1"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[4] == null ? bet.ba.split(" ")[0] : numbers[4]}
                                                            ...
                                                            <span id="mb_prize_5" className="prize3 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="ba2"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[5] == null ? bet.ba.split(" ")[1] : numbers[5]}
                                                            ...
                                                            <span id="mb_prize_6" className="prize3 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="ba3"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[6] == null ? bet.ba.split(" ")[2] : numbers[6]}
                                                            ...
                                                            <span id="mb_prize_7" className="prize3 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="ba4"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[7] == null ? bet.ba.split(" ")[3] : numbers[7]}
                                                            ...
                                                            <span id="mb_prize_8" className="prize3 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="ba5"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[8] == null ? bet.ba.split(" ")[4] : numbers[8]}
                                                            ...
                                                            <span id="mb_prize_9" className="prize3 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="ba6"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[9] == null ? bet.ba.split(" ")[5] : numbers[9]}
                                                        ...
                                                        <td>
                                                            <span id="mb_prize_10" className="prize4 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="tu1"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[10] == null ? bet.tu.split(" ")[0] : numbers[10]}
                                                            ...
                                                            <span id="mb_prize_11" className="prize4 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="tu2"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[11] == null ? bet.tu.split(" ")[1] : numbers[11]}
                                                            ...
                                                            <span id="mb_prize_12" className="prize4 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="tu3"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[12] == null ? bet.tu.split(" ")[2] : numbers[12]}
                                                            ...
                                                            <span id="mb_prize_13" className="prize4 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="tu4"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[13] == null ? bet.tu.split(" ")[3] : numbers[13]}
                                                        ...
                                                        <td>
                                                            <span id="mb_prize_14" className="prize5 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="nam1"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[14] == null ? bet.nam.split(" ")[0] : numbers[14]}
                                                            ...
                                                            <span id="mb_prize_15" className="prize5 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="nam2"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[15] == null ? bet.nam.split(" ")[1] : numbers[15]}
                                                            ...
                                                            <span id="mb_prize_16" className="prize5 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="nam6"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[16] == null ? bet.nam.split(" ")[2] : numbers[16]}
                                                            ...
                                                            <span id="mb_prize_17" className="prize5 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="nam3"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[17] == null ? bet.nam.split(" ")[3] : numbers[17]}
                                                            ...
                                                            <span id="mb_prize_18" className="prize5 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="nam4"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[18] == null ? bet.nam.split(" ")[4] : numbers[18]}
                                                            ...
                                                            <span id="mb_prize_19" className="prize5 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="nam5"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[19] == null ? bet.nam.split(" ")[5] : numbers[19]}
                                                        ...
                                                        <td>
                                                            <span id="mb_prize_20" className="prize6 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="sau1"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[20] == null ? bet.sau.split(" ")[0] : numbers[20]}
                                                            ...
                                                            <span id="mb_prize_21" className="prize6 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="sau2"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[21] == null ? bet.sau.split(" ")[1] : numbers[21]}
                                                            ...
                                                            <span id="mb_prize_22" className="prize6 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="sau3"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[22] == null ? bet.sau.split(" ")[2] : numbers[22]}
                                                        ...
                                                        <td>
                                                            <span id="mb_prize_23" className="prize7 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="bay1"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[23] == null ? bet.bay.split(" ")[0] : numbers[23]}
                                                            ...
                                                            <span id="mb_prize_24" className="prize7 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="bay2"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[24] == null ? bet.bay.split(" ")[1] : numbers[24]}
                                                            ...
                                                            <span id="mb_prize_25" className="prize7 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="bay3"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[25] == null ? bet.bay.split(" ")[2] : numbers[25]}
                                                            ...
                                                            <span id="mb_prize_26" className="prize7 div-horizontal">
                                                                <input
                                                                    ...
                                                                    name="bay4"
                                                                    style={{ width: "60px" }}
                                                                    value={numbers[26] == null ? bet.bay.split(" ")[3] : numbers[26]}
                                    ...
                                    <button type="submit" className="btn-submit btn-admin-3" style={{ display: "inline-block", margin: "0 0 0 10px", padding: "7px 12px" }}>
                                        Xác nhận
                                    </button>
                                    <button
                                        style={{ display: "inline-block", margin: "0 0 0 10px" }}
                                ...
                                <div
                                    ...
                                    <select onChange={handleChange} value={listEdit}>
                                        {list30
                                            ? list30.map((item) => {
                                                  return <option value={item?.id_bet}>Phiên {item?.id_bet}</option>;
                                              })
                                            : null}
                                    </select>
                                </div>
                                            ...
                                            <table id="table-xsmb" className="table-result table table-bordered table-striped table-xsmb">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span id="mb_prize_0" className="special-prize div-horizontal">
                                                                <input defaultValue={newChange.dacbiet} min="10000" max="99999" name="dacbiet" style={{ width: "60px" }} />
                                                            </span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span id="mb_prize_1" className="prize1 div-horizontal">
                                                                <input defaultValue={newChange.nhat} name="nhat" min="10000" max="99999" style={{ width: "60px" }} />
                                                            </span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span id="mb_prize_2" className="prize2 div-horizontal">
                                                                <input defaultValue={newChange.hai.split(" ")[0]} name="hai1" min="10000" max="99999" style={{ width: "60px" }} />
                                                            </span>
                                                            <span id="mb_prize_3" className="prize2 div-horizontal">
                                                                <input defaultValue={newChange.hai.split(" ")[1]} name="hai2" min="10000" max="99999" style={{ width: "60px" }} />
                                                            </span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span id="mb_prize_4" className="prize3 div-horizontal">
                                                                <input defaultValue={newChange.ba.split(" ")[0]} min="10000" max="99999" name="ba1" style={{ width: "60px" }} />
                                                            </span>
                                                            <span id="mb_prize_5" className="prize3 div-horizontal">
                                                                <input defaultValue={newChange.ba.split(" ")[1]} min="10000" max="99999" name="ba2" style={{ width: "60px" }} />
                                                            </span>
                                                            <span id="mb_prize_6" className="prize3 div-horizontal">
                                                                <input defaultValue={newChange.ba.split(" ")[2]} min="10000" max="99999" name="ba3" style={{ width: "60px" }} />
                                                            </span>
                                                            <span id="mb_prize_7" className="prize3 div-horizontal">
                                                                <input defaultValue={newChange.ba.split(" ")[3]} min="10000" max="99999" name="ba4" style={{ width: "60px" }} />
                                                            </span>
                                                            <span id="mb_prize_8" className="prize3 div-horizontal">
                                                                <input defaultValue={newChange.ba.split(" ")[4]} min="10000" max="99999" name="ba5" style={{ width: "60px" }} />
                                                            </span>
                                                            <span id="mb_prize_9" className="prize3 div-horizontal">
                                                                <input defaultValue={newChange.ba.split(" ")[5]} min="10000" max="99999" name="ba6" style={{ width: "60px" }} />
                                                            </span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span id="mb_prize_10" className="prize4 div-horizontal">
                                                                <input defaultValue={newChange.tu.split(" ")[0]} min="1000" max="9999" name="tu1" style={{ width: "60px" }} />
                                                            </span>
                                                            <span id="mb_prize_11" className="prize4 div-horizontal">
                                                                <input defaultValue={newChange.tu.split(" ")[1]} min="1000" max="9999" name="tu2" style={{ width: "60px" }} />
                                                            </span>
                                                            <span id="mb_prize_12" className="prize4 div-horizontal">
                                                                <input defaultValue={newChange.tu.split(" ")[2]} min="1000" max="9999" name="tu3" style={{ width: "60px" }} />
                                                            </span>
                                                            <span id="mb_prize_13" className="prize4 div-horizontal">
                                                                <input defaultValue={newChange.tu.split(" ")[3]} min="1000" max="9999" name="tu4" style={{ width: "60px" }} />
                                                            </span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span id="mb_prize_14" className="prize5 div-horizontal">
                                                                <input defaultValue={newChange.nam.split(" ")[0]} min="1000" max="9999" name="nam1" style={{ width: "60px" }} />
                                                            </span>
                                                            <span id="mb_prize_15" className="prize5 div-horizontal">
                                                                <input defaultValue={newChange.nam.split(" ")[1]} min="1000" max="9999" name="nam2" style={{ width: "60px" }} />
                                                            </span>
                                                            <span id="mb_prize_16" className="prize5 div-horizontal">
                                                                <input defaultValue={newChange.nam.split(" ")[2]} min="1000" max="9999" name="nam6" style={{ width: "60px" }} />
                                                            </span>
                                                            <span id="mb_prize_17" className="prize5 div-horizontal">
                                                                <input defaultValue={newChange.nam.split(" ")[3]} min="1000" max="9999" name="nam3" style={{ width: "60px" }} />
                                                            </span>
                                                            <span id="mb_prize_18" className="prize5 div-horizontal">
                                                                <input defaultValue={newChange.nam.split(" ")[4]} min="1000" max="9999" name="nam4" style={{ width: "60px" }} />
                                                            </span>
                                                            <span id="mb_prize_19" className="prize5 div-horizontal">
                                                                <input defaultValue={newChange.nam.split(" ")[5]} min="1000" max="9999" name="nam5" style={{ width: "60px" }} />
                                                            </span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span id="mb_prize_20" className="prize6 div-horizontal">
                                                                <input defaultValue={newChange.sau.split(" ")[0]} min="100" max="999" name="sau1" style={{ width: "60px" }} />
                                                            </span>
                                                            <span id="mb_prize_21" className="prize6 div-horizontal">
                                                                <input defaultValue={newChange.sau.split(" ")[1]} min="100" max="999" name="sau2" style={{ width: "60px" }} />
                                                            </span>
                                                            <span id="mb_prize_22" className="prize6 div-horizontal">
                                                                <input defaultValue={newChange.sau.split(" ")[2]} min="100" max="999" name="sau3" style={{ width: "60px" }} />
                                                            </span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span id="mb_prize_23" className="prize7 div-horizontal">
                                                                <input defaultValue={newChange.bay.split(" ")[0]} min="10" max="99" name="bay1" style={{ width: "60px" }} />
                                                            </span>
                                                            <span id="mb_prize_24" className="prize7 div-horizontal">
                                                                <input defaultValue={newChange.bay.split(" ")[1]} min="10" max="99" name="bay2" style={{ width: "60px" }} />
                                                            </span>
                                                            <span id="mb_prize_25" className="prize7 div-horizontal">
                                                                <input defaultValue={newChange.bay.split(" ")[2]} min="10" max="99" name="bay3" style={{ width: "60px" }} />
                                                            </span>
                                                            <span id="mb_prize_26" className="prize7 div-horizontal">
                                                                <input defaultValue={newChange.bay.split(" ")[3]} min="10" max="99" name="bay4" style={{ width: "60px" }} />
                                                            </span>
                                                        </td>
                                                    </tr>
                                                </tbody>
