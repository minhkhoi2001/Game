...
function SetXoSo() {
	...
	useEffect(() => {
		...
		axios.get(`https://d3s.vnvip294.com/Xoso3/getadmin`).then((res) => {
			setBet(res.data.data[0]);
			setDulieunhap(new Date(res.data.data[0].createdAt));
			setStart(true);
		});
		axios
			.get(`https://d3s.vnvip294.com/Xoso3/getallbet`, {})
			.then((res) => {
				setTotal(res.data.data);
			})
			.catch(() => setTotal(null));
		axios
			.get(`https://d3s.vnvip294.com/Xoso3/list30bet`, {})
			.then((res) => {
		...
		axios.get(`https://d3s.vnvip294.com/Xoso3/getcurrent`, {}).then((res) => {
	...
	const handleSubmit = (e) => {
		...
		axios
			.post("https://d3s.vnvip294.com/Xoso3/update", formData)
			.then((res) => {
