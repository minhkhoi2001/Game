...
function SetTX1p() {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/taixiu1/getadmin`).then((res) => {
        ...
        axios
            ...
            .catch(() => setTotal(null));
        axios
            .get(`${process.env.REACT_APP_API_URL}/taixiu1/list30bet`, {})
            .then((res) => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/taixiu1/getcurrent`).then((res) => {
    ...
    useEffect(() => {
        ...
        if (start) {
            ...
            myTimeout = setTimeout(() => {
                setSecond(second - 1);
                axios
                    .get(`${process.env.REACT_APP_API_URL}/taixiu1/getcurrent`)
                    .then((res) => {
                        setCurrent(res.data.data);
                    })
    ...
    const handleSubmit = (e) => {
        ...
        if (e.target.bet.value) {
            axios
                .post("https://server.best96tx.com/taixiu1/update", formData)
                .then((res) => {
