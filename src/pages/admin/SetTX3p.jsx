...
function SetTX3p() {
	...
	useEffect(() => {
		...
		axios.get(`https://server.best96tx.com/taixiu3/getadmin`).then((res) => {
		...
		axios
			...
			.catch(() => setTotal(null));
		axios
			.get(`https://server.best96tx.com/taixiu3/list30bet`, {})
			.then((res) => {
		...
		axios.get(`https://server.best96tx.com/taixiu3/getcurrent`).then((res) => {
