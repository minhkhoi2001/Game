...
function SetTX3p() {
	...
	useEffect(() => {
		...
		axios.get(`http://localhost/taixiu3/getadmin`).then((res) => {
		...
		axios
			...
			.catch(() => setTotal(null));
		axios
			.get(`http://localhost/taixiu3/list30bet`, {})
			.then((res) => {
		...
		axios.get(`http://localhost/taixiu3/getcurrent`).then((res) => {
	...
	const handleSubmit = (e) => {
		...
		if (e.target.bet.value) {
			axios
				.post("http://localhost/taixiu3/update", formData)
				.then((res) => {
