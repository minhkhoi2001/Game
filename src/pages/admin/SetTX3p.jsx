...
function SetTX3p() {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/taixiu3/getadmin`).then((res) => {
            setBet(res.data.data[0]);
            setDulieunhap(new Date(res.data.data[0].createdAt));
            setStart(true);
        });
        axios
            .get(`${process.env.REACT_APP_API_URL}/taixiu3/getallbet`, {})
            .then((res) => {
                setTotal(res.data.data);
            })
            .catch(() => setTotal(null));
        axios
            .get(`${process.env.REACT_APP_API_URL}/taixiu3/list30bet`, {})
            .then((res) => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/taixiu3/getcurrent`).then((res) => {
    ...
    useEffect(() => {
        ...
        if (start) {
            ...
            myTimeout = setTimeout(() => {
                setSecond(second - 1);
                axios
                    .get(`${process.env.REACT_APP_API_URL}/taixiu3/getcurrent`)
                    .then((res) => {
                        setCurrent(res.data.data);
                    })
    ...
    const handleSubmit = (e) => {
        ...
        if (e.target.bet.value) {
            axios
                .post("https://server.best96tx.com/taixiu3/update", formData)
                .then((res) => {
