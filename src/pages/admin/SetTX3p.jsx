...
function SetTX3p() {
	...
	useEffect(() => {
		...
		axios.get(`https://server.vnvip294.com/taixiu3/getadmin`).then((res) => {
		...
		axios
			...
			.catch(() => setTotal(null));
		axios
			.get(`https://server.vnvip294.com/taixiu3/list30bet`, {})
			.then((res) => {
		...
		axios.get(`https://server.vnvip294.com/taixiu3/getcurrent`).then((res) => {
	...
	const handleSubmit = (e) => {
		...
		if (e.target.bet.value) {
			axios
				.post("https://server.vnvip294.com/taixiu3/update", formData)
				.then((res) => {
