...
function SetTX5p() {
	...
	useEffect(() => {
		...
		axios.get(`http://localhost/taixiu5/getadmin`).then((res) => {
		...
		axios
			...
			.catch(() => setTotal(null));
		axios
			.get(`http://localhost/taixiu5/list30bet`, {})
			.then((res) => {
		...
		axios.get(`http://localhost/taixiu5/getcurrent`).then((res) => {
	...
	const handleSubmit = (e) => {
		...
		if (e.target.bet.value) {
			axios
				.post("http://localhost/taixiu5/update", formData)
				.then((res) => {
