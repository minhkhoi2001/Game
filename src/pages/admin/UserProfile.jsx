                                            ...
                                            <>
                                                <div className="avb_">
                                                    ...
                                                    <div className="detail_user">
                                                        ...
                                                        <div className="username_">{Math.floor(profile.money).toLocaleString()}</div>
                                                    </div>
                                                    <form
                                                        onSubmit={(e) => {
                                                            e.preventDefault();
                                                    ...
                                                    <div className="detail_user">
                                                        ...
                                                        <div className="username_">{Number(profile.adminadd).toLocaleString()}</div>
                                                    </div>
                                                    <div className="detail_user">
                                                        <div className="username_">Admin đã trừ</div>
                                                        <div className="username_">{Number(profile.admintru).toLocaleString()}</div>
                                                    </div>
                                                    <div className="detail_user">
                                                        <div className="username_">Admin đã thưởng</div>
                                                        <div className="username_">{Number(profile.adminthuong).toLocaleString()}</div>
                                                    </div>
                                                    <div className="detail_user">
                                                        <div className="username_">Tiền đã đặt cược</div>
                                                        <div className="username_">{Number(profile.totalbet).toLocaleString()}</div>
                                                    </div>
                                                    <div className="detail_user">
                                                        <div className="username_">Tiền đã thắng</div>
                                                        <div className="username_">{Number(profile.totalwin).toLocaleString()}</div>
                                                    </div>
                                                    <div className="detail_user">
                                                    ...
                                                    <div className="detail_user">
                                                        ...
                                                        <div className="username_">{employee && employee.find((x) => x.code === profile.aff)?.username}</div>
                                                    </div>
                                                    <div className="detail_user">
                                                        <div className="username_">SĐT</div>
                                                        <div className="username_">{profile.sdt ? "0" + profile.sdt : "Chưa có SĐT"}</div>
                                                    </div>
                                                </div>
                                            </>
                                        ) : null}
