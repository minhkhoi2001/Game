...
function Truotxien10() {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/Xoso3/get`).then((res) => {
    ...
    const onSubmit = (e) => {
        ...
        } else if (item1.length > 0 && item1.length < 10) {
                            ...
                            {total ? (
                                <>
                                    <div style={{ cursor: "pointer" }} onClick={openPopup1} className="info_bet">
                                        <div style={{ fontSize: "0.33rem" }}>
                                            Kết quả phiên <b style={{ color: "#333" }}>{total[0]?.id_bet}</b>
                                        </div>
                                        <div
                                            className="ball_xs"
                                            style={{
                                    ...
                                    <div className="title_choose_footer1">
                                        ...
                                        <div style={{ margin: "0.3rem 0 0" }} className="item_choose_footer1">
                                            <div
                                                ...
                                                <span>
                                                    Tổng tiền cược <span style={{ color: "red" }}>{item1.length != 0 && newMoney ? newMoney.toLocaleString() : 0}đ</span>
                                                </span>
                                            </div>
                                            <div
                                                style={{
                                                ...
                                                Tỉ lệ cược {setting ? "1 : " + setting.truotxien8 : "Chưa cài đặt"}
                                            </div>
