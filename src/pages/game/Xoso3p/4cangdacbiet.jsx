                                    ...
                                    <div className="title_choose_footer1">
                                        ...
                                        <div style={{ margin: "0.3rem 0 0" }} className="item_choose_footer1">
                                            <div
                                                ...
                                                <span>
                                                    Tổng tiền cược <span style={{ color: "red" }}>{newMoney ? newMoney.toLocaleString() : 0}đ</span>
                                                </span>
                                            </div>
                                            <div
                                                style={{
                                                ...
                                                Tỉ lệ cược {setting ? "1 : " + setting.bacang : "Chưa cài đặt"}
                                            </div>
