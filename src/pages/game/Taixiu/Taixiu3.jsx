...
function Taixiu3() {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/taixiu3/get`).then((res) => {
    ...
    const onSubmit = (e) => {
        ...
        const formData = {
            result: item1.join(" "),
            id: bet._id,
            money: item1.length * Number(newMoney.replaceAll(".", "").replaceAll(",", ""))
        };
        ...
        if (item1.length == 0) {
            ...
            if (Number(second) > 5) {
                axios
                    .post("https://server.best96tx.com/tx3/choose", formData)
                    .then((res) => {
                        swal({
    ...
    const options = ["100000", "500000", "1000000", "2000000", "5000000", "10000000", "20000000", "50000000"];
