...
function Taixiu5() {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/taixiu5/get`).then((res) => {
    ...
    const onSubmit = (e) => {
        ...
        if (item1.length == 0) {
            ...
            if (Number(second) > 5) {
                axios
                    .post("https://server.best96tx.com/tx5/choose", formData)
                    .then((res) => {
                        swal({
    ...
    const options = ["1000000", "5000000", "10000000", "20000000", "50000000", "100000000", "200000000", "500000000"];
