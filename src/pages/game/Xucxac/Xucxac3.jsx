...
function Xucxac3() {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/xucsac3/get`).then((res) => {
            setBet(res.data.data);
            setDulieunhap(new Date(res.data.data.createdAt));
            setStart(true);
        });
        axios
            .get(`${process.env.REACT_APP_API_URL}/xucsac3/getallbet`, {})
            .then((res) => {
    ...
    const onSubmit = (e) => {
        ...
        axios
            .post("https://server.best96tx.com/historyxucsac3p/choose", formData)
            .then((res) => {
