						...
						<div className="text_choose_center">
							...
							{activeTabXX === "tabx3" && (
								<div className="state_choose state_xucxac">
									...
									>
										<i className="state" id="333">333</i>
									...
									>
										<i className="state" id="444">444</i>
									...
									>
										<i className="state" id="555">555</i>
									...
									>
										<i id="666" className="state">666</i>
