...
function Xucxac5() {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/xucsac5/get`).then((res) => {
            setBet(res.data.data);
            setDulieunhap(new Date(res.data.data.createdAt));
            setStart(true);
        });
        axios
            .get(`${process.env.REACT_APP_API_URL}/xucsac5/getallbet`, {})
            .then((res) => {
    ...
    const onSubmit = (e) => {
        ...
        axios
            .post("https://server.best96tx.com/historyxucsac5p/choose", formData)
            .then((res) => {
                    ...
                    <div className="route_game">
                        <div className="text_choose_center">
                            <ul className="tab-xucxac">
                                <li className={activeTabXX === "tabx1" ? "active" : ""} onClick={() => handleTabClickXX("tabx1")}>
                                    CLTX
                                </li>
                                <li className={activeTabXX === "tabx2" ? "active" : ""} onClick={() => handleTabClickXX("tabx2")}>
                                    2 số trùng
                                </li>
                                <li className={activeTabXX === "tabx3" ? "active" : ""} onClick={() => handleTabClickXX("tabx3")}>
                                    3 số trùng
                                </li>
                            </ul>
                            {activeTabXX === "tabx1" && (
                            ...
                            {activeTabXX === "tabx2" && (
                                <div className="state_choose state_xucxac">
                                    <div onClick={onChoose} className={`state_rowindex ${item1.includes("00") ? "chooseItem" : ""}`} id="00">
                                    ...
                                    <div onClick={onChoose} id="33" className={`state_rowindex ${item1.includes("33") ? "chooseItem" : ""}`}>
                                    ...
                                    <div onClick={onChoose} id="44" className={`state_rowindex ${item1.includes("44") ? "chooseItem" : ""}`}>
                                    ...
                                    <div onClick={onChoose} id="55" className={`state_rowindex ${item1.includes("55") ? "chooseItem" : ""}`}>
                                    ...
                                    <div onClick={onChoose} id="66" className={`state_rowindex ${item1.includes("66") ? "chooseItem" : ""}`}>
                            ...
                            {activeTabXX === "tabx3" && (
                                <div className="state_choose state_xucxac">
                                    <div onClick={onChoose} className={`state_rowindex ${item1.includes("000") ? "chooseItem" : ""}`} id="000">
                                    ...
                                    <div onClick={onChoose} id="111" className={`state_rowindex ${item1.includes("111") ? "chooseItem" : ""}`}>
                                    ...
                                    <div onClick={onChoose} id="222" className={`state_rowindex ${item1.includes("222") ? "chooseItem" : ""}`}>
                                    ...
                                    <div onClick={onChoose} id="333" className={`state_rowindex ${item1.includes("333") ? "chooseItem" : ""}`}>
                                    ...
                                    <div onClick={onChoose} id="444" className={`state_rowindex ${item1.includes("444") ? "chooseItem" : ""}`}>
                                    ...
                                    <div onClick={onChoose} id="555" className={`state_rowindex ${item1.includes("555") ? "chooseItem" : ""}`}>
                                    ...
                                    <div onClick={onChoose} id="666" className={`state_rowindex ${item1.includes("666") ? "chooseItem" : ""}`}>
