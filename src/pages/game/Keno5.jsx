...
function Keno5() {
	...
	const onSubmit =  (e) => {
		...
		axios.post("https://server.st666.pro/history5/choose",formData).then((res)=>swal("Chọn thành công")).catch((err)=>swal("Chọn không thành công"))
	};
			...
			<div className="app1">
				<div className="info_profile">
					<div className="cycle_bet">
						...
						<span className="title_game_header"> Kendo 5p</span>
					</div>
