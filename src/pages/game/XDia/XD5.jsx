...
function XD5() {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/xd5/get`).then((res) => {
            setBet(res.data.data);
            setDulieunhap(new Date(res.data.data.createdAt));
            setStart(true);
        });
        axios
            .get(`${process.env.REACT_APP_API_URL}/xd5/getallbet`, {})
            .then((res) => {
    ...
    const onSubmit = (e) => {
        ...
        const formData = {
            result: choose.join(" "),
            id: bet?._id,
            money: choose.length * Number(newMoney.replaceAll(".", "").replaceAll(",", ""))
        };
            ...
            <div className="main xd">
                ...
                <div className="box-bg-game">
                    <div className="bg-game">
                        <div data-v-45adac70="" className="v_circle taste_lottery_countdown xodi  v_circle_show v_circle_PC">
                        ...
                        <div className="boxdia">
                            <img alt="" src={chen} className="point" style={{ animation: "movePointBack" }} />
                        ...
                        <div className="timexd">
                            <span style={{ fontSize: "0.4rem" }}>Phiên {bet?.id_bet}</span> <br />
                            <span style={{ opacity: "0.7" }}>{bet ? formatDate(new Date(bet.createdAt)) : null}</span>
                        </div>
                    </div>
                </div>
                <div>
                    <button className={`taste_unit_item ${choose.includes("6") ? "active" : ""}`} onClick={(e) => onChoose("6")}>
                        <div className="taste_unit_img taste_unit_img_DAN"></div>
                        <div className="taste_unit_odds">{setting && setting.le}</div>
                    </button>
                    <button className={`taste_unit_item ${choose.includes("5") ? "active" : ""}`} onClick={(e) => onChoose("5")}>
                        <div className="taste_unit_img taste_unit_img_SHUANG"></div>
                        <div className="taste_unit_odds">{setting && setting.chan}</div>
                    </button>
                    <button className={`taste_unit_item ${choose.includes("4") ? "active" : ""}`} onClick={(e) => onChoose("4")}>
                        <div>
                    ...
                    <button className={`taste_unit_item ${choose.includes("3") ? "active" : ""}`} onClick={(e) => onChoose("3")}>
                        <div>
                            <div className="nums_yxx_qw">
                                <div className="taste_unit_item_yxx taste_unit_item_r die"></div>
                                <div className="taste_unit_item_yxx taste_unit_item_r die"></div>
                    ...
                    <button className={`taste_unit_item ${choose.includes("2") ? "active" : ""}`} onClick={(e) => onChoose("2")}>
                        <div>
                            <div className="nums_yxx_qw">
                                <div className="taste_unit_item_yxx taste_unit_item_w die"></div>
                                <div className="taste_unit_item_yxx taste_unit_item_w die"></div>
                    ...
                    <button className={`taste_unit_item ${choose.includes("1") ? "active" : ""}`} onClick={(e) => onChoose("1")}>
                        <div>
                            <div className="nums_yxx_qw">
                                <div className="taste_unit_item_yxx taste_unit_item_r die"></div>
                                <div className="taste_unit_item_yxx taste_unit_item_r die"></div>
                ...
                <div className="bet_taste_chips">
                    ...
                    <div data-v-331b32c3="" className={`taste_chips_swiper_item ${activeOption === "10000" ? "active" : ""}`} onClick={() => handleOptionClick("10000")}>
                        <div data-v-331b32c3="" className="taste_chip">
                    ...
                    <div data-v-331b32c3="" className={`taste_chips_swiper_item ${activeOption === "5000" ? "active" : ""}`} onClick={() => handleOptionClick("50000")}>
                        <div data-v-331b32c3="" className="taste_chip">
                                                    ...
                                                    <div
                                                        ...
                                                        <div className="item_history">
                                                            <div className="title_item_history">
                                                                <span className="sanh" style={{ color: "#f5f5f5" }}>
                                                                    {item.sanh}
                                                                </span>
                                                                <span
