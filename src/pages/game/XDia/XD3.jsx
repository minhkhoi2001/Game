...
function XD3() {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/xd3/get`).then((res) => {
            setBet(res.data.data);
            setDulieunhap(new Date(res.data.data.createdAt));
            setStart(true);
        });
        axios
            .get(`${process.env.REACT_APP_API_URL}/xd3/getallbet`, {})
            .then((res) => {
    ...
    const onSubmit = (e) => {
        ...
        if (Number(second) > 5) {
            if (choose.length == 0) {
                ...
                axios
                    .post("https://server.best96tx.com/cxd3/choose", formData)
                    .then((res) => {
                        swal({
