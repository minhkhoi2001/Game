...
const CountDown = ({ date }) => {
    ...
    if (currentHour < 18 || (currentHour === 18 && currentMinute < 10) || currentHour >= 19) {
        if (currentHour < 18 || (currentHour === 18 && currentMinute < 10)) {
            targetTime1 = new Date();
            targetTime1.setHours(18, 10, 0, 0);
            targetTime2 = new Date();
            targetTime2.setHours(18, 15, 0, 0);
        } else {
            targetTime1 = getNextTargetTime(currentTime, 18, 10);
            targetTime2 = getNextTargetTime(currentTime, 18, 15);
        }
    } else if (currentHour == 18 && currentMinute > 10 && currentMinute < 15) {
        targetTime1 = new Date();
        targetTime2 = new Date();
        targetTime2.setHours(18, 15, 0, 0);
    } else {
