...
function Xoso() {
    ...
    useEffect(() => {
        axios.get(`https://mu88.live/api/front/open/lottery/history/list/5/miba`).then((res) => {
            setBet(res.data.t);
            setTotal([
                {
    ...
    const onSubmit = (e) => {
        ...
        if (Number(currentDate.getHours() + "" + minute) > 1810 && Number(currentDate.getHours() + "" + minute) < 1900) {
            ...
            const formData = {
                ...
                type: 1,
                money: item1.length * newMoney * 27000
            };
            if (item1.length == 0) {
                                    ...
                                    <div className="title_choose_footer1">
                                        <div className="item_choose_footer1">
                                            <div>
                                                <div
                                                    ...
                                                    Nhập số điểm lô (1 điểm = 27.000đ)
                                                </div>
                                                <input
                                                    value={newMoney}
                                        ...
                                        <div style={{ margin: "0.3rem 0 0" }} className="item_choose_footer1">
                                            <div
                                                ...
                                                <span>
                                                    Tổng tiền cược{" "}
                                                    <span style={{ color: "red" }}>{item1.length != 0 && newMoney ? (item1.length * newMoney * 27000).toLocaleString() : 0}đ</span>
                                                </span>
                                            </div>
                                            <div
                                                style={{
                                                ...
                                                Tiền thắng/1 con: {setting ? (setting.mblothuong * 27000).toLocaleString() + "đ" : "Chưa cài đặt"}
                                            </div>
