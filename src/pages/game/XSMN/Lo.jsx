...
function Xoso() {
    ...
    const onSubmit = (e) => {
        ...
        //console.log(Number(currentDate.getHours() + "" + minute));
        if (Number(currentDate.getHours() + "" + minute) > 1610 && Number(currentDate.getHours() + "" + minute) < 1700) {
            ...
            const formData = {
                ...
                id: bet.turnNum,
                type: 1,
                money: item1.length * newMoney * 18000,
                sanh: bet.name
            };
            if (item1.length == 0) {
                                    ...
                                    <div className="title_choose_footer1">
                                        <div className="item_choose_footer1">
                                            <div>
                                                <div
                                                    ...
                                                    Nhập số điểm lô (1 điểm = 18.000đ)
                                                </div>
                                                <input
                                                    value={newMoney}
                                        ...
                                        <div style={{ margin: "0.3rem 0 0" }} className="item_choose_footer1">
                                            <div
                                                ...
                                                <span>
                                                    Tổng tiền cược{" "}
                                                    <span style={{ color: "red" }}>{item1.length != 0 && newMoney ? (item1.length * newMoney * 18000).toLocaleString() : 0}đ</span>
                                                </span>
                                            </div>
                                            <div
                                                style={{
                                                ...
                                                Tiền thắng/1 con: {setting ? (setting.mnlothuong * 18000).toLocaleString() + "đ" : "Chưa cài đặt"}
                                            </div>
