...
function Set1() {
	...
	useEffect(() => {
		...
		axios.get(`https://server.best96tx.com/bet1/getadmin`).then((res) => {
			setBet(res.data.data[0]);
			setDulieunhap(new Date(res.data.data[0].createdAt));
			setStart(true);
		});
		axios
			.get(`https://server.best96tx.com/bet1/getallbet`, {})
			.then((res) => {
				setTotal(res.data.data);
			})
			.catch(() => setTotal(null));
		axios
			.get(`https://server.best96tx.com/bet1/list30bet`, {})
			.then((res) => {
		...
		axios.get(`https://server.best96tx.com/bet1/getcurrent`).then((res) => {
																...
																<form
																	onSubmit={(e) => {
																		...
																		if (e.target.result.value) {
																			axios
																				.post(
																					"https://server.best96tx.com/bet1/update",
																					formData
																				)
																				.then((res) => {
