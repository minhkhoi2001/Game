...
function HistoryAll() {
    ...
    useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_API_URL}/auth/biendongsodu`, {})
            .then((res) => {
                                    ...
                                    <>
                                        <div className="item_inner">
                                            <div className="item_history">
                                                ...
                                                <div className="id_history_sanh">Phiên cược: {item?.id_bet.id_bet}</div>
                                            </div>
                                            <div className="money_history">
                                                <span className="money">
                                                    {item.status_bet === "Win" ? "+" : item.status_bet === "Lose" ? "-" : ""}
                                        ...
                                        <div className="item_inner">
                                            <div className="item_history">
                                                <div className="title_item_history">
                                                    ...
                                                    <span className={`type_state ${item.type_payment === "NẠP" ? "win" : item.type_payment === "RÚT" ? "lose" : "pending"}`}>
                                                        {item.type_payment}
                                                    </span>
                                                </div>
                                            ...
                                            <div className="money_history">
                                                <span className="money">
                                                    {item.type_payment === "NẠP" ? "+" : item.type_payment === "RÚT" ? "-" : ""}
                                                    {Number(item.money).toLocaleString()}đ
                                                </span>
                                                <div className="time_choose">{formatDate(new Date(item.createdAt))}</div>
                                            </div>
