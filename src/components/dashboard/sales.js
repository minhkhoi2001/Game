...
export const Sales = (props) => {
                ...
                datasets: [
                    {
                        ...
                        data: [res.data.data.motphut.tongcuoc, res.data.data.baphut.tongcuoc, res.data.data.namphut.tongcuoc, res.data.data.xoso.tongcuoc],
                        label: "Tổng cược",
                        maxBarThickness: 10
                    },
                    {
                        ...
                        borderRadius: 4,
                        categoryPercentage: 0.5,
                        data: [res.data.data.motphut.tongthang, res.data.data.baphut.tongthang, res.data.data.namphut.tongthang, res.data.data.xoso.tongthang],
                        label: "Thắng",
                        maxBarThickness: 10
                    }
                ],
    ...
    return (
        <Card {...props}>
            <CardHeader title="Thống kê đặt cược" />
            <Divider />
            <CardContent>
                <Box
                    sx={{
